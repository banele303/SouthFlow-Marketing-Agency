...
export default function OurStystems() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="w-full flex flex-col justify-center items-center  md:pl-8 px-[.5rem] md:px-[2rem]"
      >
        <motion.h2 className="text-[17px] md:text-[25px] font-bold  pt-[.3rem] text-center text-blue-500">
          Proven Ad Campaigns Ready To Go!
        </motion.h2>
        <p className="text-[16px] md:text-[20px] font-bold mb-7 pt-[1rem] pl-[5rem] ">
          You only have to select which Facebook ad campaigns you want to run.
        </p>
        <ul className="p-2">
          <li>
            <div className="flex flex-row justify-center text-[15px] md:text-[20px]   pt-[.3rem]  text-blue-500">
              ...
              <span className="p-3"> general plumbing services</span>
            </div>
          </li>
          ...
          <li>
            <p className="text-[15px] md:text-[20px]   pt-[.3rem]  text-blue-500">
