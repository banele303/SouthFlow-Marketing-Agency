...
export default function LeakyLeads() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="w-full flex flex-col  items-center   px-[.5rem]"
      >
        <motion.h2 className="text-[17px] md:text-[25px] font-bold text-start  pt-[.3rem]  text-blue-500">
      STEP TWO  -  Fix Your Leaky Leads
        </motion.h2>
        <p className="text-[16px] md:text-[18px] text-slate-300  mb-7 pt-[1rem]">
          Stop Losing Leads to missed calls and slow follow up! <br/> 
          Leads come in from phone,text,email,web forms,web chat, google ads,google maps, facebook ads...<br/><br/>
          That&apos;s just twoo many platforms to monitor at once and respond
        </p>
        <ul className="p-2">
          <li>
            <div className="flex flex-row  text-[15px] md:text-[20px]     text-blue-500">
              ...
              <span className=" px-3 mt-[-.4rem] text-slate-300 text-[16px] pt-2">
                Our One-Inbox & automated lead messaging plugs those hole in your leaky leads busket!
          ...
          <li>
            <div className="flex flex-row  text-[15px] md:text-[20px]     text-blue-500">
              ...
              <span className=" px-3 mt-[-.4rem] text-slate-300 text-[16px] pt-2">
                Our A.I Receptionist intsantly enagges income leads and books appointments on your calender!
              </span>
            </div>
          </li>
          <li>
            <div className="flex flex-row  text-[15px] md:text-[20px]     text-blue-500">
              ...
              <span className=" px-3 mt-[-.4rem] text-slate-300 text-[16px] pt-2">
                Dominate speed-tolead in your market  and convert more leads into Jobs
              </span>
            </div>
          </li>
      ...
      >
        <Image
          src="/plumber/funnel.png" // the image file should be in the public folder
