...
export default function AdvertisingFBAds() {
  ...
  return (
    <motion.div
      ...
      className="grid grid-cols-1 md:grid-cols-2 w-full custom-negative-z-index gap-8 pt-[4rem]   px-[1rem]"
    >
      {/* Right Section */}
      <motion.div
        initial={{ y: 200 }}
      ...
      >
        ...
        <p className="text-[16px] md:text-[20px] text-slate-600 font-bold mb-7 pt-[1rem] pl-[5rem] ">
          Stop Losing Leads to missed calls and slow follow up! <br/> <br/>
        ...
        <ul className="p-2">
          <li>
            <div className="flex flex-row  text-[15px] md:text-[20px]     text-blue-500">
              ...
              <span className=" px-3 mt-[-.4rem] text-slate-500 pt-2">
              We offer Easy 5-Click Facebook Ad Campaigns with our A.I. Receptionist for Plumbers!
              </span>
            </div>
          </li>
          <li>
            <div className="flex flex-row  text-[15px] md:text-[20px]     text-blue-500">
              ...
              <span className=" px-3 mt-[-.4rem] text-slate-500 pt-2">
              Integrated with Facebook ad manager
              </span>
            </div>
          </li>
          <li>
          ...
          <li>
            <div className="flex flex-row  text-[15px] md:text-[20px]     text-blue-500">
              ...
              <span className=" px-3 mt-[-.4rem] text-slate-500 pt-2">
              Select from 10 proven plumbing campaigns
              </span>
            </div>
          </li>
          <li>
          ...
          <li>
            <div className="flex flex-row  text-[15px] md:text-[20px]     text-blue-500">
              ...
              <span className=" px-3 mt-[-.4rem] text-slate-500 pt-2">
           <strong>   AI Receptionist engages all leads + books appointments</strong>
              </span>
            </div>
          </li>
