...
export default function WorldClassSupport() {
  ...
  return (
    <motion.div
      ...
      className="grid grid-cols-1 md:grid-cols-2 w-full dark:bg-white bg-black  dark:bg-dot-black/[0.2] bg-dot-white/[0.2] custom-negative-z-index gap-8 pt-[4rem]   px-[1rem]"
    >
      ...
      >
        <Image
          src="/plumber/support.png" // the image file should be in the public folder
