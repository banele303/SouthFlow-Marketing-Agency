    ...
    >
      ...
      >
        <motion.h2 className="text-[17px] md:text-[25px] font-bold  pt-[.3rem] text-center text-blue-500">
         STEP 1 Grow Fast Sales Without Ads!
        </motion.h2>
        <p className="text-[16px] md:text-[20px] text-slate-200 font-bold mb-7 pt-[1rem] pl-[5rem] ">
        Create immediate sales with our Customer Reactivation Campaigns. <br/><br/>
        Get reconnected to your past customers to add sales quickly without new ads!
        </p>
        <ul className="p-2">
          <li>
          ...
          <li>
            <div className="flex flex-row  text-[15px] md:text-[20px]     text-blue-500">
              ...
              <span className=" px-3 mt-[-.4rem] text-slate-300 pt-2">
              mmediate sales without new ads
...
Grow more referrals
          ...
          <li>
            <div className="flex flex-row  text-[15px] md:text-[20px]     text-blue-500">
              ...
              <span className=" px-3 mt-[-.4rem] text-slate-300 pt-2">
              Best return on investment of any marketing!
              </span>
            </div>
          </li>
      ...
      >
        <Image
          src="/plumber/sales.png" // the image file should be in the public folder
